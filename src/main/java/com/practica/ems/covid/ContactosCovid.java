...
public class ContactosCovid {
	...
	public void loadDataFile(String fichero, boolean reset) {
		...
		// El try-with-resources se encarga de cerrar el BufferedReader automáticamente
...
// --- MÉTODOS PRIVADOS AUXILIARES PARA EVITAR DUPLICIDAD ---

	private void resetearEstructuras() {
		this.poblacion = new Poblacion();
		this.localizacion = new Localizacion();
		this.listaContactos = new ListaContactos();
	}

	private void procesarRegistro(String[] datos) throws EmsInvalidTypeException, EmsInvalidNumberOfDataException,
			EmsDuplicatePersonException, EmsDuplicateLocationException {
